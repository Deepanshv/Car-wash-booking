    ...
    <Paper elevation={0} sx={{ p: { xs: 2, sm: 4 } }}>
        ...
        <Box component="form" onSubmit={handleSubmit} sx={{ mt: 2 }}>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ mt: 3 }}>
                <Button type="submit" variant="contained" color="primary" size="large" fullWidth disabled={isSubmitting} startIcon={isSubmitting && <CircularProgress size={20} color="inherit" />}>
