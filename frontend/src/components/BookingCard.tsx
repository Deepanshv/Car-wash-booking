  ...
  return (
    ...
    <Dialog open={deleteDialogOpen} onClose={() => !isDeleting && setDeleteDialogOpen(false)}>
      ...
      <DialogActions sx={{ p: 2, pt: 0 }}>
        <Button onClick={() => setDeleteDialogOpen(false)} disabled={isDeleting} variant="outlined">Cancel</Button>
        <Button onClick={handleConfirmDelete} disabled={isDeleting} color="error" variant="contained" autoFocus startIcon={isDeleting && <CircularProgress size={20} color="inherit" />}>
