  ...
  return (
    ...
    <Dialog open={openDialog} onClose={isDeleting ? undefined : () => setOpenDialog(false)}>
      ...
      <DialogActions sx={{ pb: 2, px: 3 }}>
        <Button onClick={() => setOpenDialog(false)} variant="outlined" disabled={isDeleting}>Cancel</Button>
        <Button onClick={handleDelete} variant="contained" color="error" disabled={isDeleting} startIcon={isDeleting && <CircularProgress size={20} color="inherit" />}>
